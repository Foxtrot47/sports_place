  ...
  if ($result->num_rows > 0) {
    ...
    if ($hashed_pass == $row["seller_password"]) {
      if ($row["verified"] == 1) {
        ...
        // Caching all values to session so we can access them without reaching database
        $_SESSION["seller_id"] = $row["seller_id"];
        $_SESSION["seller_email"] = $row["seller_email"];
        $_SESSION["first_name"] = $row["first_name"];
        $_SESSION["last_name"] = $row["last_name"];
        $_SESSION["seller_org"] = $row["seller_org"];
        $_SESSION["seller_session_id"] = $token;
        ...
        header("Location: " . "listings.php");
         ...
         ?>
                ...
                window.addEventListener('DOMContentLoaded', (event) => {
                    document.getElementById('auth_error_text').innerHTML = "You aren't verified yet";
    ...
    >
        ...
        <div class="px-4 py-2 -mx-3">
            <div class="mx-3">
                ...
                <p id="auth_error_text"class="text-sm text-gray-600 dark:text-gray-200">You typed wrong email or password</p>
            </div>
        </div>
    </div>
                ...
                <form method="post" action="<?php echo htmlspecialchars(
                  $_SERVER["PHP_SELF"]
                    ...
                    <div class="mt-4">
                        ...
                        <input id="auth_email" name="auth_email" class="block w-full px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 
                    ...
                    <div class="flex items-center justify-between mt-4">
                        ...
                        <a href="seller_signup.php" class="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">or sign up</a>

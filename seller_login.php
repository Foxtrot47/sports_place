...
<div class="flex max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
        ...
        <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
            ...
            <p class="text-xl text-center text-gray-600 dark:text-gray-200">Welcome to Merchant Page</p>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Get the hashed password of seller
    ...
    if ($result->num_rows > 0) {
        ...
        if ( $hashed_pass == $row['seller_password'] ) {
            ...
            $insert_q = 'UPDATE sellers SET session_token ="' . $session_token  . '" WHERE seller_email="' . $email . '"';

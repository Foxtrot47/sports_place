                    ...
                    <div class="flex flex-col">
                        <div class="pb-4">
                            ...
                            <div class="py-4 flex flex-row gap-2">
                                <input type="text" class="p-2 bg-gray-100 border-gray-300 rounded border antialiased" disabled value=<?php echo $_SESSION[
                                    "first_name"
                                ]; ?> >
                                <input type="text" class="p-2 bg-gray-100 border-gray-300 rounded border antialiased" disabled value=<?php echo $_SESSION[
                                    "last_name"
                        ...
                        <div class="pt-6">
                            ...
                            <div class="py-4 flex flex-row gap-2">
                                <input type="number" class="p-2 bg-gray-100 border-gray-300 rounded border antialiased" disabled value=<?php echo $addr_row[
                                    "addr_mobile_num"
                                ]; ?> >
                            </div>
                        </div>
                        <div class="pt-6">
                            ...
                            <div class="py-4 flex flex-row gap-2">
                                <input type="date" class="p-2 bg-gray-100 border-gray-300 rounded border antialiased" disabled value=<?php echo $addr_row[
                                    "addr_dob"
                                ]; ?> >
                            </div>
                        </div>
